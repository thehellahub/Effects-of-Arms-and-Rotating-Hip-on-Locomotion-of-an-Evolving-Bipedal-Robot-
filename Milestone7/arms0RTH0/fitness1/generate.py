...
def Create_Brain():
    ...
    pyrosim.Send_Motor_Neuron(name=7, jointName="LowerLleg_LFoot")
    pyrosim.Send_Motor_Neuron(name=8, jointName="LowerRleg_RFoot")
    pyrosim.Send_Motor_Neuron(name=9, jointName="UpperLleg_LowerLleg")
    pyrosim.Send_Motor_Neuron(name=10, jointName="UpperRleg_LowerRleg")
    pyrosim.Send_Motor_Neuron(name=11, jointName="Torso_Hip")
    pyrosim.Send_Motor_Neuron(name=12, jointName="Hip_UpperLleg")
    pyrosim.Send_Motor_Neuron(name=13, jointName="Hip_UpperRleg")
