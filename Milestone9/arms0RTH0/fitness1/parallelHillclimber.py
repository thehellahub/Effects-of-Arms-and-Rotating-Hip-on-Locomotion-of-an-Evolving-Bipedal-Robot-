...
class PARALLEL_HILL_CLIMBER:
    ...
    def Select(self):
        for index in self.parents:
            print(f"\nself.parents[{index}].fitness: {self.parents[index].fitness}: {type(self.parents[index].fitness)}")
            print(f"self.children[{index}].fitness : {self.children[index].fitness}: {type(self.children[index].fitness)}")
