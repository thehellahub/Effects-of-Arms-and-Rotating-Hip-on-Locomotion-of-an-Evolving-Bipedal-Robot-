...
class ROBOT:
    ...
    def Check_If_Standing(self):
        ...
        self.heights.append(zPosition_of_head)
    ...
    def Get_Fitness(self):
        ...
        with open(f'fitness{self.solutionID}.txt', 'w') as f:
            f.write( str( xCoordinateOfLinkZero * (zCoordinateOfLinkZero**2) * (time_standing_upright**2) * (sum(self.heights)/len(self.heights)) ) )
